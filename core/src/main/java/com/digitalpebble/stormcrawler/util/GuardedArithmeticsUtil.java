...
public final class GuardedArithmeticsUtil {
     ...
     */
    @Contract(pure = true)
    private static void checkIfOverflowHappenedBySignumPlus(int signumA, int signumB, int signumResult) {
        if (signumA == -1 && signumB == -1 && signumResult == 1) {
            throw new ArithmeticException("Numeric overflow has happened! (signum changed: (-) + (-) = (+))");
        }
        if (signumA == 1 && signumB == 1 && signumResult == -1){
            throw new ArithmeticException("Numeric overflow has happened! (signum changed: (+) + (+) = (-))");
        }
     ...
     */
    @Contract(pure = true)
    private static void checkIfOverflowHappenedBySignumMinus(int signumA, int signumB, int signumResult) {
        if (signumA == -1 && signumB == 1 && signumResult == 1) {
            throw new ArithmeticException("Numeric overflow has happened! (signum changed: (-) - (+) = (+))");
        }
        if (signumA == 1 && signumB == -1 && signumResult == -1){
    ...
    public static int plus(int a, int b) {
        int result = a + b;
        checkIfOverflowHappenedBySignumPlus(Integer.signum(a), Integer.signum(b), Integer.signum(result));
        return result;
    }
    ...
    public static int minus(int a, int b) {
        int result = a - b;
        checkIfOverflowHappenedBySignumMinus(Integer.signum(a), Integer.signum(b), Integer.signum(result));
        return result;
    }
    ...
    @TestOnly
    @Contract(pure = true)
    static void test_checkIfOverflowHappenedBySignumPlus(int signumA, int signumB, int signumResult) {
        checkIfOverflowHappenedBySignumPlus(signumA, signumB, signumResult);
    }

    @TestOnly
    @Contract(pure = true)
    static void test_checkIfOverflowHappenedBySignumMinus(int signumA, int signumB, int signumResult) {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("[err] min + -9 = "+ GuardedArithmeticsUtil.plus(Integer.MIN_VALUE, -9));
        } catch (ArithmeticException e){
        ...
        try {
            System.out.println("[err] max + 9 = "+ GuardedArithmeticsUtil.plus(Integer.MAX_VALUE, 9));
        } catch (ArithmeticException e){
        ...
        try {
            System.out.println("[err] min - 9 = "+ GuardedArithmeticsUtil.minus(Integer.MIN_VALUE, 9));
        } catch (ArithmeticException e){
            System.out.print("min - -9 = ");
            System.out.println(e.getMessage());
        }
        ...
        try {
            System.out.println("[err] max - -9 = "+ GuardedArithmeticsUtil.minus(Integer.MAX_VALUE, -9));
        } catch (ArithmeticException e){
            System.out.print("max - -9 = ");
            System.out.println(e.getMessage());
        }
