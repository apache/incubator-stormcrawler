...
public class ParserBolt extends BaseRichBolt {
    ...
    private List<Outlink> toOutlinks(String url, List<Link> links,
        ...
        for (Link l : links) {
            ...
            // as well as the ones that could have been generated by the
            // parseFilters
            metadataTransfer.setMetaForOutlink(ol, url, parentMetadata);
