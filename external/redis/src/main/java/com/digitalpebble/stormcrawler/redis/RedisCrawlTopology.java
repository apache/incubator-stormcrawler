...
public class RedisCrawlTopology extends ConfigurableTopology {

    public static void main(String[] args) throws Exception {
        ConfigurableTopology.start(new RedisCrawlTopology(), args);
    }
    ...
    protected int run(String[] args) {
        ...
        builder.setSpout("spout", new RedisSpout(), numShards);
        ...
        builder.setBolt("indexer", new StatusStreamBolt(), numWorkers)
