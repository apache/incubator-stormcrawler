...
public class Fetcher extends BaseRichBolt {
		...
		public void run() {
			...
			while (true) {
				...
				try {
					...
					// update the stats
					// eventStats.scope("KB downloaded").update((long) content.length / 1024l);
	...
	public void prepare(Map stormConf, TopologyContext context,
        ...
        this.eventCounter = context.registerMetric("fetcher-counter",new MultiCountMetric(),5);
        ...
        this.eventStats = context.registerMetric("fetcher-stats",new MultiReducedMetric(new MeanReducer()),5);
