...
public class IndexerBolt extends AbstractIndexerBolt {
    ...
    public void execute(Tuple tuple) {
        ...
        try {
            ...
            StringBuilder query = new StringBuilder(" insert into ")
                    .append(tableName).append(" (").append(fieldNameForURL());
    ...
    private void insert(PreparedStatement preparedStmt, int position,
            String label, Map<String, String[]> keyVals) throws SQLException {
