 ...
 * from the crawled content. They are used exclusively by
 * {@link com.digitalpebble.stormcrawler.bolt.JSoupParserBolt}.
 */
public abstract class JSoupFilter implements Configurable {
	 ...
	 */
	public abstract void filter(String URL, byte[] content, org.jsoup.nodes.Document doc, ParseResult parse);
