...
/**
 * Normalises the MimeType value e.g. text/html; charset=UTF-8 => HTML
 * application/pdf => PDF and creates a new entry with a key 'format' in the
 * metadata. Requires the JSoupParserBolt to be used with the configuration
 * _detect.mimetype_ set to true.
 **/
